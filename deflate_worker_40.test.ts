...
test("Deflate roundtrip - worker 40", async () => {
...
test("ICO encode/decode - worker 40", async () => {
...
test("PNG pipeline - worker 40", async () => {
...
test("Concurrent deflate ops - worker 40", async () => {
...
test("Full image pipeline - worker 40", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 40", async () => {
