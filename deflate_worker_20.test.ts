...
test("Deflate roundtrip - worker 20", async () => {
...
test("ICO encode/decode - worker 20", async () => {
...
test("PNG pipeline - worker 20", async () => {
...
test("Concurrent deflate ops - worker 20", async () => {
...
test("Full image pipeline - worker 20", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 20", async () => {
