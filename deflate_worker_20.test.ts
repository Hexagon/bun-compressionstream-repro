/**
 * Worker file 20/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-20: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-20: deflateData small payload", async () => {
...
test("worker-20: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-20: sequential deflate calls", async () => {
...
test("worker-20: deflateData large payload", async () => {
