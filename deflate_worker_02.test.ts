/**
 * Worker file 02/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-02: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-02: deflateData small payload", async () => {
...
test("worker-02: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-02: sequential deflate calls", async () => {
...
test("worker-02: deflateData large payload", async () => {
