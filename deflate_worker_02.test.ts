...
test("Deflate roundtrip - worker 02", async () => {
...
test("ICO encode/decode - worker 02", async () => {
...
test("PNG pipeline - worker 02", async () => {
...
test("Concurrent deflate ops - worker 02", async () => {
...
test("Full image pipeline - worker 02", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 02", async () => {
