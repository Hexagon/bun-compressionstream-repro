...
test("Deflate roundtrip - worker 06", async () => {
...
test("ICO encode/decode - worker 06", async () => {
...
test("PNG pipeline - worker 06", async () => {
...
test("Concurrent deflate ops - worker 06", async () => {
...
test("Full image pipeline - worker 06", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 06", async () => {
