/**
 * Worker file 06/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-06: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-06: deflateData small payload", async () => {
...
test("worker-06: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-06: sequential deflate calls", async () => {
...
test("worker-06: deflateData large payload", async () => {
