...
test("Deflate roundtrip - worker 09", async () => {
...
test("ICO encode/decode - worker 09", async () => {
...
test("PNG pipeline - worker 09", async () => {
...
test("Concurrent deflate ops - worker 09", async () => {
...
test("Full image pipeline - worker 09", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 09", async () => {
