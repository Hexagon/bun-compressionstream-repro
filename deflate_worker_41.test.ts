...
test("Deflate roundtrip - worker 41", async () => {
...
test("ICO encode/decode - worker 41", async () => {
...
test("PNG pipeline - worker 41", async () => {
...
test("Concurrent deflate ops - worker 41", async () => {
...
test("Full image pipeline - worker 41", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 41", async () => {
