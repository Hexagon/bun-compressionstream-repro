...
test("Deflate roundtrip - worker 23", async () => {
...
test("ICO encode/decode - worker 23", async () => {
...
test("PNG pipeline - worker 23", async () => {
...
test("Concurrent deflate ops - worker 23", async () => {
...
test("Full image pipeline - worker 23", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 23", async () => {
