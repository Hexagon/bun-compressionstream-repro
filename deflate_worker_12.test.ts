/**
 * Worker file 12/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-12: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-12: deflateData small payload", async () => {
...
test("worker-12: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-12: sequential deflate calls", async () => {
...
test("worker-12: deflateData large payload", async () => {
