...
test("Deflate roundtrip - worker 12", async () => {
...
test("ICO encode/decode - worker 12", async () => {
...
test("PNG pipeline - worker 12", async () => {
...
test("Concurrent deflate ops - worker 12", async () => {
...
test("Full image pipeline - worker 12", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 12", async () => {
