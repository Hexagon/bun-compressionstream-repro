...
test("Deflate roundtrip - worker 49", async () => {
...
test("ICO encode/decode - worker 49", async () => {
...
test("PNG pipeline - worker 49", async () => {
...
test("Concurrent deflate ops - worker 49", async () => {
...
test("Full image pipeline - worker 49", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 49", async () => {
