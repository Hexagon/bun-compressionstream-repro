...
test("Deflate roundtrip - worker 34", async () => {
...
test("ICO encode/decode - worker 34", async () => {
...
test("PNG pipeline - worker 34", async () => {
...
test("Concurrent deflate ops - worker 34", async () => {
...
test("Full image pipeline - worker 34", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 34", async () => {
