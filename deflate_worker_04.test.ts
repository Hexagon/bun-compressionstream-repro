/**
 * Worker file 04/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-04: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-04: deflateData small payload", async () => {
...
test("worker-04: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-04: sequential deflate calls", async () => {
...
test("worker-04: deflateData large payload", async () => {
