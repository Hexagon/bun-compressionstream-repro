...
test("Deflate roundtrip - worker 04", async () => {
...
test("ICO encode/decode - worker 04", async () => {
...
test("PNG pipeline - worker 04", async () => {
...
test("Concurrent deflate ops - worker 04", async () => {
...
test("Full image pipeline - worker 04", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 04", async () => {
