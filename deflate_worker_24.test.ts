...
test("Deflate roundtrip - worker 24", async () => {
...
test("ICO encode/decode - worker 24", async () => {
...
test("PNG pipeline - worker 24", async () => {
...
test("Concurrent deflate ops - worker 24", async () => {
...
test("Full image pipeline - worker 24", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 24", async () => {
