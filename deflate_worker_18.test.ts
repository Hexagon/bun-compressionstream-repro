/**
 * Worker file 18/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-18: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-18: deflateData small payload", async () => {
...
test("worker-18: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-18: sequential deflate calls", async () => {
...
test("worker-18: deflateData large payload", async () => {
