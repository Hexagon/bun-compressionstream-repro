...
test("Deflate roundtrip - worker 18", async () => {
...
test("ICO encode/decode - worker 18", async () => {
...
test("PNG pipeline - worker 18", async () => {
...
test("Concurrent deflate ops - worker 18", async () => {
...
test("Full image pipeline - worker 18", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 18", async () => {
