...
test("Deflate roundtrip - worker 19", async () => {
...
test("ICO encode/decode - worker 19", async () => {
...
test("PNG pipeline - worker 19", async () => {
...
test("Concurrent deflate ops - worker 19", async () => {
...
test("Full image pipeline - worker 19", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 19", async () => {
