/**
 * Worker file 19/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-19: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-19: deflateData small payload", async () => {
...
test("worker-19: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-19: sequential deflate calls", async () => {
...
test("worker-19: deflateData large payload", async () => {
