...
test("Deflate roundtrip - worker 37", async () => {
...
test("ICO encode/decode - worker 37", async () => {
...
test("PNG pipeline - worker 37", async () => {
...
test("Concurrent deflate ops - worker 37", async () => {
...
test("Full image pipeline - worker 37", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 37", async () => {
