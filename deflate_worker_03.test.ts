...
test("Deflate roundtrip - worker 03", async () => {
...
test("ICO encode/decode - worker 03", async () => {
...
test("PNG pipeline - worker 03", async () => {
...
test("Concurrent deflate ops - worker 03", async () => {
...
test("Full image pipeline - worker 03", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 03", async () => {
