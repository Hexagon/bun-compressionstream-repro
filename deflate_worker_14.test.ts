...
test("Deflate roundtrip - worker 14", async () => {
...
test("ICO encode/decode - worker 14", async () => {
...
test("PNG pipeline - worker 14", async () => {
...
test("Concurrent deflate ops - worker 14", async () => {
...
test("Full image pipeline - worker 14", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 14", async () => {
