/**
 * Worker file 14/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-14: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-14: deflateData small payload", async () => {
...
test("worker-14: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-14: sequential deflate calls", async () => {
...
test("worker-14: deflateData large payload", async () => {
