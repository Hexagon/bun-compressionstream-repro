...
test("Deflate roundtrip - worker 44", async () => {
...
test("ICO encode/decode - worker 44", async () => {
...
test("PNG pipeline - worker 44", async () => {
...
test("Concurrent deflate ops - worker 44", async () => {
...
test("Full image pipeline - worker 44", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 44", async () => {
