/**
 * Worker file 08/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-08: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-08: deflateData small payload", async () => {
...
test("worker-08: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-08: sequential deflate calls", async () => {
...
test("worker-08: deflateData large payload", async () => {
