...
test("Deflate roundtrip - worker 08", async () => {
...
test("ICO encode/decode - worker 08", async () => {
...
test("PNG pipeline - worker 08", async () => {
...
test("Concurrent deflate ops - worker 08", async () => {
...
test("Full image pipeline - worker 08", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 08", async () => {
