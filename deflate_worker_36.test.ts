...
test("Deflate roundtrip - worker 36", async () => {
...
test("ICO encode/decode - worker 36", async () => {
...
test("PNG pipeline - worker 36", async () => {
...
test("Concurrent deflate ops - worker 36", async () => {
...
test("Full image pipeline - worker 36", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 36", async () => {
