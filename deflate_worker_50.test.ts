...
test("ICO encode/decode - worker 50", async () => {
...
test("PNG pipeline - worker 50", async () => {
...
test("Concurrent deflate ops - worker 50", async () => {
...
test("Full image pipeline - worker 50", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 50", async () => {
