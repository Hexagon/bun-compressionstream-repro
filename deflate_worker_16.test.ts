...
test("Deflate roundtrip - worker 16", async () => {
...
test("ICO encode/decode - worker 16", async () => {
...
test("PNG pipeline - worker 16", async () => {
...
test("Concurrent deflate ops - worker 16", async () => {
...
test("Full image pipeline - worker 16", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 16", async () => {
