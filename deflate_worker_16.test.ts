/**
 * Worker file 16/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-16: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-16: deflateData small payload", async () => {
...
test("worker-16: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-16: sequential deflate calls", async () => {
...
test("worker-16: deflateData large payload", async () => {
