/**
 * Worker file 05/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-05: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-05: deflateData small payload", async () => {
...
test("worker-05: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-05: sequential deflate calls", async () => {
...
test("worker-05: deflateData large payload", async () => {
