...
test("Deflate roundtrip - worker 05", async () => {
...
test("ICO encode/decode - worker 05", async () => {
...
test("PNG pipeline - worker 05", async () => {
...
test("Concurrent deflate ops - worker 05", async () => {
...
test("Full image pipeline - worker 05", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 05", async () => {
