...
test("Deflate roundtrip - worker 27", async () => {
...
test("ICO encode/decode - worker 27", async () => {
...
test("PNG pipeline - worker 27", async () => {
...
test("Concurrent deflate ops - worker 27", async () => {
...
test("Full image pipeline - worker 27", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 27", async () => {
