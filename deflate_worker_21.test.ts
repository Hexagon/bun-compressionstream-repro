...
test("Deflate roundtrip - worker 21", async () => {
...
test("ICO encode/decode - worker 21", async () => {
...
test("PNG pipeline - worker 21", async () => {
...
test("Concurrent deflate ops - worker 21", async () => {
...
test("Full image pipeline - worker 21", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 21", async () => {
