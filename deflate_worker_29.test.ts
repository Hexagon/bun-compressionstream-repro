...
test("Deflate roundtrip - worker 29", async () => {
...
test("ICO encode/decode - worker 29", async () => {
...
test("PNG pipeline - worker 29", async () => {
...
test("Concurrent deflate ops - worker 29", async () => {
...
test("Full image pipeline - worker 29", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 29", async () => {
