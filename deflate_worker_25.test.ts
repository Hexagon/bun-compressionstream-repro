...
test("Deflate roundtrip - worker 25", async () => {
...
test("ICO encode/decode - worker 25", async () => {
...
test("PNG pipeline - worker 25", async () => {
...
test("Concurrent deflate ops - worker 25", async () => {
...
test("Full image pipeline - worker 25", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 25", async () => {
