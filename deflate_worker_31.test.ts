...
test("Deflate roundtrip - worker 31", async () => {
...
test("ICO encode/decode - worker 31", async () => {
...
test("PNG pipeline - worker 31", async () => {
...
test("Concurrent deflate ops - worker 31", async () => {
...
test("Full image pipeline - worker 31", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 31", async () => {
