...
test("Deflate roundtrip - worker 45", async () => {
...
test("ICO encode/decode - worker 45", async () => {
...
test("PNG pipeline - worker 45", async () => {
...
test("Concurrent deflate ops - worker 45", async () => {
...
test("Full image pipeline - worker 45", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 45", async () => {
