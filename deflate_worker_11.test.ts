...
test("Deflate roundtrip - worker 11", async () => {
...
test("ICO encode/decode - worker 11", async () => {
...
test("PNG pipeline - worker 11", async () => {
...
test("Concurrent deflate ops - worker 11", async () => {
...
test("Full image pipeline - worker 11", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 11", async () => {
