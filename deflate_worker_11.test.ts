/**
 * Worker file 11/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-11: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-11: deflateData small payload", async () => {
...
test("worker-11: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-11: sequential deflate calls", async () => {
...
test("worker-11: deflateData large payload", async () => {
