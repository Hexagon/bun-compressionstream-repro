...
test("Deflate roundtrip - worker 26", async () => {
...
test("ICO encode/decode - worker 26", async () => {
...
test("PNG pipeline - worker 26", async () => {
...
test("Concurrent deflate ops - worker 26", async () => {
...
test("Full image pipeline - worker 26", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 26", async () => {
