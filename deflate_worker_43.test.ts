...
test("Deflate roundtrip - worker 43", async () => {
...
test("ICO encode/decode - worker 43", async () => {
...
test("PNG pipeline - worker 43", async () => {
...
test("Concurrent deflate ops - worker 43", async () => {
...
test("Full image pipeline - worker 43", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 43", async () => {
