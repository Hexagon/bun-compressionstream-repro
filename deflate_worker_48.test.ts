...
test("Deflate roundtrip - worker 48", async () => {
...
test("ICO encode/decode - worker 48", async () => {
...
test("PNG pipeline - worker 48", async () => {
...
test("Concurrent deflate ops - worker 48", async () => {
...
test("Full image pipeline - worker 48", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 48", async () => {
