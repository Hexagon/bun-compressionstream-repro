...
test("Deflate roundtrip - worker 39", async () => {
...
test("ICO encode/decode - worker 39", async () => {
...
test("PNG pipeline - worker 39", async () => {
...
test("Concurrent deflate ops - worker 39", async () => {
...
test("Full image pipeline - worker 39", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 39", async () => {
