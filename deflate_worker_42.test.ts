...
test("Deflate roundtrip - worker 42", async () => {
...
test("ICO encode/decode - worker 42", async () => {
...
test("PNG pipeline - worker 42", async () => {
...
test("Concurrent deflate ops - worker 42", async () => {
...
test("Full image pipeline - worker 42", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 42", async () => {
