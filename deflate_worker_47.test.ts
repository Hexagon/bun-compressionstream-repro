...
test("Deflate roundtrip - worker 47", async () => {
...
test("ICO encode/decode - worker 47", async () => {
...
test("PNG pipeline - worker 47", async () => {
...
test("Concurrent deflate ops - worker 47", async () => {
...
test("Full image pipeline - worker 47", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 47", async () => {
