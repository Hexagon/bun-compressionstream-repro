...
test("Deflate roundtrip - worker 17", async () => {
...
test("ICO encode/decode - worker 17", async () => {
...
test("PNG pipeline - worker 17", async () => {
...
test("Concurrent deflate ops - worker 17", async () => {
...
test("Full image pipeline - worker 17", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 17", async () => {
