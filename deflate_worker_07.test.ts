...
test("Deflate roundtrip - worker 07", async () => {
...
test("ICO encode/decode - worker 07", async () => {
...
test("PNG pipeline - worker 07", async () => {
...
test("Concurrent deflate ops - worker 07", async () => {
...
test("Full image pipeline - worker 07", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 07", async () => {
