/**
 * Worker file 07/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-07: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-07: deflateData small payload", async () => {
...
test("worker-07: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-07: sequential deflate calls", async () => {
...
test("worker-07: deflateData large payload", async () => {
