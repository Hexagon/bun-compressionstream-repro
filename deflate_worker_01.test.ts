...
test("Deflate roundtrip - worker 01", async () => {
...
test("ICO encode/decode - worker 01", async () => {
...
test("PNG pipeline - worker 01", async () => {
...
test("Concurrent deflate ops - worker 01", async () => {
...
test("Full image pipeline - worker 01", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 01", async () => {
