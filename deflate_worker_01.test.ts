/**
 * Worker file 01/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-01: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-01: deflateData small payload", async () => {
...
test("worker-01: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-01: sequential deflate calls", async () => {
...
test("worker-01: deflateData large payload", async () => {
