...
test("Deflate roundtrip - worker 15", async () => {
...
test("ICO encode/decode - worker 15", async () => {
...
test("PNG pipeline - worker 15", async () => {
...
test("Concurrent deflate ops - worker 15", async () => {
...
test("Full image pipeline - worker 15", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 15", async () => {
