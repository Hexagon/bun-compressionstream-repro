/**
 * Worker file 15/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-15: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-15: deflateData small payload", async () => {
...
test("worker-15: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-15: sequential deflate calls", async () => {
...
test("worker-15: deflateData large payload", async () => {
