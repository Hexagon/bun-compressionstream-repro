...
test("Deflate roundtrip - worker 35", async () => {
...
test("ICO encode/decode - worker 35", async () => {
...
test("PNG pipeline - worker 35", async () => {
...
test("Concurrent deflate ops - worker 35", async () => {
...
test("Full image pipeline - worker 35", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 35", async () => {
