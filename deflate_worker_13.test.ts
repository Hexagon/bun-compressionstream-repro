/**
 * Worker file 13/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-13: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-13: deflateData small payload", async () => {
...
test("worker-13: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-13: sequential deflate calls", async () => {
...
test("worker-13: deflateData large payload", async () => {
