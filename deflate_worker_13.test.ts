...
test("Deflate roundtrip - worker 13", async () => {
...
test("ICO encode/decode - worker 13", async () => {
...
test("PNG pipeline - worker 13", async () => {
...
test("Concurrent deflate ops - worker 13", async () => {
...
test("Full image pipeline - worker 13", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 13", async () => {
