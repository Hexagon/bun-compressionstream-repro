...
test("Deflate roundtrip - worker 46", async () => {
...
test("ICO encode/decode - worker 46", async () => {
...
test("PNG pipeline - worker 46", async () => {
...
test("Concurrent deflate ops - worker 46", async () => {
...
test("Full image pipeline - worker 46", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 46", async () => {
