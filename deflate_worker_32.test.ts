...
test("Deflate roundtrip - worker 32", async () => {
...
test("ICO encode/decode - worker 32", async () => {
...
test("PNG pipeline - worker 32", async () => {
...
test("Concurrent deflate ops - worker 32", async () => {
...
test("Full image pipeline - worker 32", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 32", async () => {
