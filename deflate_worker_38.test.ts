...
test("Deflate roundtrip - worker 38", async () => {
...
test("ICO encode/decode - worker 38", async () => {
...
test("PNG pipeline - worker 38", async () => {
...
test("Concurrent deflate ops - worker 38", async () => {
...
test("Full image pipeline - worker 38", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 38", async () => {
