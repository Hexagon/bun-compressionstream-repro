...
test("Deflate roundtrip - worker 33", async () => {
...
test("ICO encode/decode - worker 33", async () => {
...
test("PNG pipeline - worker 33", async () => {
...
test("Concurrent deflate ops - worker 33", async () => {
...
test("Full image pipeline - worker 33", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 33", async () => {
