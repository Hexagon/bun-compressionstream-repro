...
test("Deflate roundtrip - worker 22", async () => {
...
test("ICO encode/decode - worker 22", async () => {
...
test("PNG pipeline - worker 22", async () => {
...
test("Concurrent deflate ops - worker 22", async () => {
...
test("Full image pipeline - worker 22", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 22", async () => {
