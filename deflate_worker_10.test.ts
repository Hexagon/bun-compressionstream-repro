/**
 * Worker file 10/20 — replicates the EXACT deflateData/inflateData pattern
...
test("worker-10: deflateData + inflateData roundtrip (first call triggers dynamic import)", async () => {
...
test("worker-10: deflateData small payload", async () => {
...
test("worker-10: inflateData only (zlib pre-cached after first test)", async () => {
...
test("worker-10: sequential deflate calls", async () => {
...
test("worker-10: deflateData large payload", async () => {
