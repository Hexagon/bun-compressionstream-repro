...
test("Deflate roundtrip - worker 28", async () => {
...
test("ICO encode/decode - worker 28", async () => {
...
test("PNG pipeline - worker 28", async () => {
...
test("Concurrent deflate ops - worker 28", async () => {
...
test("Full image pipeline - worker 28", async () => {
  const format = new PNGFormat();
...
test("Large image deflate - worker 28", async () => {
